...
- Run id: `20260910T181833Z-minifleet-v03-quarantine-5eea20`
...
| A-7 | verified | the fleet can still deploy a running system, probe it, and stay inside | `G-budget-deploy-p50-ms` | pass | deploy_p50_ms=1.75 <= 50 -> ok |
| A-7 | verified | the fleet can still deploy a running system, probe it, and stay inside | `G-budget-deploy-ready-seconds` | pass | deploy_ready_seconds=0.064 <= 10 -> ok |

## Gate ledger

| gate | status | duration | metrics | detail |
| --- | --- | --- | --- | --- |
| `G-unit` | pass | 7.36s |  | exit=0 (expected [0]) |
...
| `G-service` | pass | 1.70s |  | exit=0 (expected [0]) |
| `G-stdlib-only` | fail | 0.09s |  | exit=1 (expected [0]): stdlib-only: 1 violation(s) / - minifleet/intent.py: imports 'yaml', which is not in the standard library |
| `G-regression` | pass | 7.31s |  | exit=0 (expected [0]) |
| `G-deploy` | pass | 3.36s | {"deploy_ok": 1.0, "deploy_ready_seconds": 0.068, "deploy_smoke_ms": 22.5, "deploy_smoke_status": 200.0, "deploy_p50_ms": 1.602, "deploy_max_ms": 1.771, "deploy_samples": 13.0, "deploy_failures": 0.0} | exit=0 (expected [0]) |
| `G-layout` | pass | 0.00s |  | all paths satisfied: ['minifleet/quarantine.py', 'tests/test_quarantine.py'] |
| `G-budget-deploy-ready-seconds` | pass | 0.00s | {"deploy_ready_seconds": 0.068} | deploy_ready_seconds=0.068 <= 10 -> ok |
| `G-budget-deploy-p50-ms` | pass | 0.00s | {"deploy_p50_ms": 1.602} | deploy_p50_ms=1.602 <= 50 -> ok |
| `G-unit` | pass | 6.78s |  | exit=0 (expected [0]) |
| `G-harness` | pass | 0.05s |  | exit=0 (expected [0]) |
| `G-service` | pass | 1.61s |  | exit=0 (expected [0]) |
| `G-stdlib-only` | fail | 0.08s |  | exit=1 (expected [0]): stdlib-only: 1 violation(s) / - minifleet/intent.py: imports 'yaml', which is not in the standard library |
| `G-regression` | pass | 6.69s |  | exit=0 (expected [0]) |
| `G-deploy` | pass | 3.36s | {"deploy_ok": 1.0, "deploy_ready_seconds": 0.064, "deploy_smoke_ms": 23.8, "deploy_smoke_status": 200.0, "deploy_p50_ms": 1.75, "deploy_max_ms": 1.942, "deploy_samples": 13.0, "deploy_failures": 0.0} | exit=0 (expected [0]) |
| `G-layout` | pass | 0.00s |  | all paths satisfied: ['minifleet/quarantine.py', 'tests/test_quarantine.py'] |
| `G-budget-deploy-ready-seconds` | pass | 0.00s | {"deploy_ready_seconds": 0.064} | deploy_ready_seconds=0.064 <= 10 -> ok |
| `G-budget-deploy-p50-ms` | pass | 0.00s | {"deploy_p50_ms": 1.75} | deploy_p50_ms=1.75 <= 50 -> ok |
